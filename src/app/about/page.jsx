...
export const metadata = {
  title: "About Us | Techlab Scientific Solutions",
    ...
    <div className={styles.aboutPage}>
      ...
      <section className={styles.headerSection} aria-labelledby="about-title">
        <div className={styles.container}>
          <AnimationWrapper type="fade-down" className={styles.headerContent}>
      ...
      <section className={styles.principleHero} aria-label="One Principle">
        <div className={styles.heroOverlay}>
          <div className={styles.containerHero}>
            <AnimationWrapper type="scale" className={styles.heroContent}>
